	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussyingyuanxinxi`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																												...
																																																																												if(this.ruleForm.id){
					await this.$api.update(`discussyingyuanxinxi`, this.ruleForm);
				}else{
					await this.$api.add(`discussyingyuanxinxi`, this.ruleForm);
				}
				uni.setStorageSync('discussyingyuanxinxiCleanType',true);
